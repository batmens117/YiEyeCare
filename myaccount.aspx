...
<li>
        ...
        <!-- CONTENT --------------------------------------------------------------------------------->
        <!-- Intro Section -->
        <section class="inner-intro dark-bg bg-image overlay-dark parallax parallax-background1" data-background-img="images/account.jpg">
            <div class="container">
                <div class="row title">
        ...
        <section class="ptb ptb-sm-80">
            <div class="container">
                ...
                <div class="table" style="border-style: none; border-width: thin">
                    ...
                    <table class="updateacc" style="margin: 0px auto 0px auto; text-align: center" id="updatetable">
                        <tr>
                            <td class="auto-style7" style="border-style: solid; border-width: thin">Username</td>
                        ...
                        <tr>
                            <td class="auto-style4" style="border-style: solid; border-width: thin">Right Eye Degree</td>
                            <td class="auto-style2" style="border-style: solid; border-width: thin">
                                <asp:Label ID="redlbl" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style4" style="border-style: solid; border-width: thin">Left Eye Degree</td>
                            <td class="auto-style2" style="border-style: solid; border-width: thin">
                                <asp:Label ID="ledlbl" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style4" style="border-style: solid; border-width: thin">Medical Condition</td>
                            <td class="auto-style2" style="border-style: solid; border-width: thin">
                                <asp:Label ID="mclbl" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style4" style="border-style: solid; border-width: thin">Reward Points</td>
                            <td class="auto-style2" style="border-style: solid; border-width: thin">
                                <asp:Label ID="rplbl" runat="server"></asp:Label>
                            </td>
                        </tr>
                        </table>
