<%@ Page Language="C#" AutoEventWireup="true" CodeFile="privacypolicy.aspx.cs" Inherits="termsncondition"  %>
...
<head>
    <meta charset="utf-8" />
    <title>Yi Eyecare - Privacy Policy</title>
                                ...
                                <div id="tabs-1" class="plr-0">
                                 ...
                                 <form runat="server">     
                                        <div class="form-field-wrapper">
                                            <label for="login-email">What does this privacy policy cover?</label>  
                                            <br />
                                            YiEyecare takes your privacy very seriously. This privacy policy governs and details the main privacy principles we apply to the data we collect through our services.
                                             
                                        </div>
                                        <div class="form-field-wrapper">
                                            <label for="login-pass">About Yi Eyecare's Service</label>
                                            <br />
                                           
                                            YiEyecare specializes in the spectacles industry. We work with overseas partners to provide the best quality of spectacles for you. 

Our aim is to deliver advertisements by displaying products and/or personalized banners that you might be interested in,
                                             based on your recent browsing behavior. Our mission and vision is also to enable 
                                            the best shopping experience available for you.
                                            
                                        </div>

                                      <div class="form-field-wrapper">
                                            <label for="login-email">Important Notes</label>  
                                            <br />
                                          This website contains material which is owned by or licensed to Lumi. This material includes, but is not limited to, the design, layout, look, appearance and graphics.
