<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apptbookingnew.aspx.cs" Inherits="Login"  %>
...
<head>
    <meta charset="utf-8" />
    <title>Yi Eyecare - Appointment Booking</title>
...
<li>
        ...
        <!-- CONTENT --------------------------------------------------------------------------------->
        <!-- Intro Section -->
         <section class="inner-intro dark-bg bg-image overlay-dark parallax parallax-background1" data-background-img="images/appt.jpg">
            <div class="container">
                <div class="row title">
                    <h2 class="h2">Appointment Booking</h2>
                                ...
                                <div id="tabs-1" class="plr-0">
                                 ...
                                 <form runat="server">     
                                        <div class="form-field-wrapper">
                                            <label for="login-email">Select Date</label> 
                                            
                                            <asp:TextBox ID="Datetb" runat="server" class="input-sm form-full" TextMode="Date"></asp:TextBox>
                                             <br /><asp:Button ID="checkdatebtn" runat="server" Text="Check Date" class="btn btn-md btn-black" OnClick="checkdatebtn_Click"  />
                                        </div>

                                                <asp:GridView ID="GridView1" CssClass="table table-hover" GridLines="None" runat="server"></asp:GridView>

                                        <div class="form-field-wrapper">
                                           <label for="login-email">Select Time</label>
                                            <asp:DropDownList ID="timeddl" class="input-sm form-full" runat="server"></asp:DropDownList>
                                                                                        
                                        </div>

                                      <div class="form-field-wrapper">
                                           <label for="login-email">Message</label>
                                          <asp:TextBox ID="msgtb" class="input-sm form-full" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                                                        
                                        </div>
                                        <asp:Button ID="bookapptbtn" runat="server" class="btn btn-md btn-black" Text="Book Appointment" OnClick="bookapptbtn_Click" />
