<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Spectacles.aspx.cs" Inherits="Spectacles" %>
...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- CONTENT --------------------------------------------------------------------------------->
        <!-- Intro Section -->
        <section class="inner-intro dark-bg bg-image overlay-dark parallax parallax-background1" data-background-img="img/SpectaclesImage.jpg">
            <div class="container">
                <div class="row title">
                    <h2 class="h2">Shop Spectacles</h2>
                </div>
            </div>
        </section>
        <!-- End Intro Section -->
...
<form runat="server">
<section>
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:YECConnectionString %>" SelectCommand="SELECT ProdName, ProdPrice, ProdUrl, ProdID FROM Products WHERE ProdType=@ProdType;">
    <SelectParameters>
        <asp:QueryStringParameter DefaultValue="Frame" Name="ProdType" QueryStringField="ProdType" />
    </SelectParameters>
    </asp:SqlDataSource>
<asp:DataList ID="DataList1" runat="server" DataKeyField="ProdID" DataSourceID="SqlDataSource1" RepeatColumns="4" RepeatDirection="Horizontal">
...
<ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                        ...
                        <!-- Shop item images -->
                                <div class="item-img">
                                <asp:HyperLink ID="HyperLink2" runat="server" ImageUrl='<%# Eval("ProdUrl") %>' NavigateURL='<%# Eval ("ProdUrl", "~/ProductDetails2.aspx?ProdUrl={0}") %>' Text= '<%# Bind ("ProdID")%>' ImageHeight="215px" ImageWidth="240px"></asp:HyperLink>
                            </div>
                          <!--  <div class="item-mask">
            ...
            <!--End shop item-->
                ...
                <div class="pagination-nav mtb-30">
                    <ul>
                        ...
                        <li class="active"><a href="#">1             <li><a href="#">2</a></li>
                        <li><a href="#">3</a></li>
