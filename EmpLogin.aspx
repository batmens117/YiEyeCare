<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpLogin.aspx.cs" Inherits="EmpLogin" Debug="true" %>
       ...
       =
        ...
        <section class="ptb ptb-sm-80">
           ...
           <form runat="server" style="text-align: center">
               <asp:Label ID="EmpIDLabel" runat="server" Text="Employee ID"></asp:Label><asp:TextBox ID="IDTextBox" runat="server" TextMode="Number"></asp:TextBox>

               <br />
               <asp:Label ID="EmpPassLabel" runat="server" Text="Password"></asp:Label>
