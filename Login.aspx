                                ...
                                <div id="tabs-1" class="plr-0">
                                 ...
                                 <form runat="server">     
                                        <div class="form-field-wrapper">
                                            <label for="login-email">User Name</label><asp:TextBox ID="liuserid" runat="server" class="input-sm form-full" ></asp:TextBox>
                                             
                                        </div>
                                        <div class="form-field-wrapper">
                                            <label for="login-pass">Password</label><asp:TextBox ID="lipassword" runat="server" class="input-sm form-full" Textmode="Password"></asp:TextBox>
                                            
                                        </div>
                                       
                                        <asp:Button ID="signinbtn" runat="server" Text="Sign In" class="btn btn-md btn-black" OnClick="signinbtn_Click" />
                                        <asp:Label ID="displaylbl" runat="server"></asp:Label>
                                        <a class="float-right" href="forgotpassword.aspx">Forgot password?</a>
                                        <asp:Button ID="RegisterBtn" runat="server" class="btn btn-md btn-black" Text="No account? Register here" OnClick="RegisterBtn_Click" />
                          </form> 
                                    </div>
                                ...
                                <div id="tabs-2" class="plr-0">
                                    <h4>Admin Portal</h4>
                                        ...
                                        <div class="form-field-wrapper">
                                            ...
                                            Click <a href="EmpLogin.aspx" style="color:blue; text-decoration:underline; font-weight:bold;" >HERE</a> to be redirected to Admin page.
