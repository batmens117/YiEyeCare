...
<li>
        ...
        <!-- CONTENT --------------------------------------------------------------------------------->
        <!-- Intro Section -->
        <section class="inner-intro dark-bg bg-image overlay-dark parallax parallax-background1" data-background-img="img/full/f1.jpeg">
            <div class="container">
                <div class="row title">
                    <h2 class="h2">Faq</h2>
                    <div class="page-breadcrumb">
                        <a href="Default.aspx" >Home</a>/<span>Faq</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="accordion">
                    <div class="accordion-section">
                        <h6 class="accordion-title">Where do we get our goods/products from?</h6>
                        <div class="accordion-content">
                            <p>We don't manufacture our own products. All lenses and frames are purchased from our suppliers.</p>
                        </div>
                    </div>
                    <div class="accordion-section">
                        <h6 class="accordion-title">Does the frames spoil easily?</h6>
                        <div class="accordion-content">
                            <p>Products offered are of quality assurance. However, it depends on how you handle it as well. It have a general lifespan of 5-8years if its well taken care of.</p>
                        </div>
                    </div>
                    <div class="accordion-section">
                        <h6 class="accordion-title">How do I store it?</h6>
                        <div class="accordion-content">
                            <p>You can keep it in the spectacles box or alternatively place it in a container / places that are not subjected to possible crushing of spectacles.</p>
                            <p></p>
                        </div>
                    </div>
                    <div class="accordion-section">
                        <h6 class="accordion-title">How do i claim warranty/refund? </h6>
                        <div class="accordion-content">
                            <p>This is subjected to a case by case basis.</p>
                            <p>1. If it spoils within the warranty date that is not caused by human error, you can drop by our shop to claim warranty.</p>
                            <p>2. Manufacturing Defect. You can come down to our shop for a 1-for-1 exchange. </p>
                            <p>3. Refunding if the spectacles doesn't suit you is not plausible, however you may exchange it for another frame with the same lens size. </p>
                        </div>
                    </div>
