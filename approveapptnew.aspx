<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approveapptnew.aspx.cs" Inherits="approveapptnew"  %>
    ...
    <div class="wrapper">
        ...
        <section id="Pricing" class="ptb ptb-sm-80">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" style="margin-left: 10px;">
<!-- why does this create a margin left of 500px omg I chage to 10px. -->
                        ...
                        <div class="tabs b-lrb-none">
                                ...
                                <div id="tabs-1" class="plr-0">
                                 ...
                                 <form runat="server">     
                                        <div class="form-field-wrapper">
                                           ...
                                           <asp:GridView ID="GridView2" CssClass="table table-hover" GridLines="None" AutoGenerateColumns="False" runat="server" DataSourceID="SqlDataSource1">
                            ...
                            <asp:BoundField DataField="email" HeaderText="email" SortExpression="email"></asp:BoundField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                        <asp:Button id="finalizebtn" runat="server" OnClick="finalizebtn_OnClick" class="btn btn-md btn-black" Text="Finalize" />
                                                            </ItemTemplate>
                                                    </asp:TemplateField>
                        </Columns>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:YECConnectionString2 %>" SelectCommand="SELECT [EmpID], [EmpName], [bookingDate], [UserName], [bookingTime], [email],[Remarks],[bookingStatus] FROM [Bookings] WHERE ([bookingStatus] = 'Pending' OR [bookingStatus] = 'Finalised');">
                                            </asp:SqlDataSource>
