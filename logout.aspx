                        ...
                        <div class="tabs b-lrb-none">
                            ...
                            <div class="ui-tab-content">
                                <div id="tabs-1" class="plr-0">
                                    <h4>Customer Signout</h4>
                                 <form runat="server">     
                                        <div class="form-field-wrapper">
                                            <label for="login-email">Dear valued customer,</label>
                                            <p>Thank you for shopping with us! <br />
                                               We hope you enjoyed your stay here with us, if there's any enquiries,
                                               feel free to engage in our chat service or direct your question <a href="location.aspx">HERE</a>.
                                        ...
                                        <asp:Button ID="signoutbtn" runat="server" Text="Sign out" class="btn btn-md btn-black" OnClick="signoutbtn_Click" />
